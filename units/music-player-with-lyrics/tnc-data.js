...
var tncData = [
    {
        ...
        lyricsPlayer: {
            lyrics: [
                ...
                { line: "Let's take it back to the present simple", time: convertTimeToMS('1:08') },
                { line: 'I do', time: convertTimeToMS('1:11') },
                { line: 'You do', time: convertTimeToMS('1:12') },
                { line: 'He does She does It does', time: convertTimeToMS('1:14') },
                { line: 'You do', time: convertTimeToMS('1:16') },
                { line: 'They do', time: convertTimeToMS('1:18') },
                { line: 'And we do everything', time: convertTimeToMS('1:195') },
                { line: 'Present continuous', time: convertTimeToMS('1:215') },
                { line: 'I am doing', time: convertTimeToMS('1:228') },
                { line: 'You are doing', time: convertTimeToMS('1:24') },
                { line: 'He is doing', time: convertTimeToMS('1:258') },
                { line: 'She is doing', time: convertTimeToMS('1:266') },
                { line: 'It is doing', time: convertTimeToMS('1:28') },
                { line: 'You are doing', time: convertTimeToMS('1:295') },
                { line: 'They are doing', time: convertTimeToMS('1:30') },
                { line: 'And we are doing us', time: convertTimeToMS('1:32') },
                { line: 'Simple past', time: convertTimeToMS('1:33') },
                { line: 'I did', time: convertTimeToMS('1:34') },
                { line: 'You did', time: convertTimeToMS('1:36') },
    ...
    },
    {
        ...
        lyricsPlayer: {
            lyrics: [
                ...
                { line: 'How many is countable', time: convertTimeToMS('0:50') },
                { line: 'How many brothers do you have?', time: convertTimeToMS('0:52') },
                { line: 'How much asks about one thing', time: convertTimeToMS('0:55') },
                { line: 'How much money was the cab?', time: convertTimeToMS('0:58') },
                { line: 'How many is countable', time: convertTimeToMS('1:00') },
                { line: 'How many people are in the house?', time: convertTimeToMS('1:04') },
                { line: 'How much asks about one thing', time: convertTimeToMS('1:06') },
                { line: 'How much money was the couch?', time: convertTimeToMS('1:09') },
                { line: 'How many, many, how much?', time: convertTimeToMS('1:12') },
                { line: 'How many things, how much stuff?', time: convertTimeToMS('1:15') },
                { line: 'How many, many, how much?', time: convertTimeToMS('1:18') },
                { line: 'How many things? How much stuff', time: convertTimeToMS('1:26') },
                { line: '', time: convertTimeToMS('1:23') }
                // { line: 'I am doing', time: convertTimeToMS('0:235') },
                // { line: 'You are doing', time: convertTimeToMS('0:252') },
                // { line: 'He is doing', time: convertTimeToMS('0:26') },
                // { line: 'She is doing', time: convertTimeToMS('0:275') },
    ...
    },
    {
        ...
        lyricsPlayer: {
            lyrics: [
                { line: '', time: 0 },
                { line: 'What is that?', time: convertTimeToMS('0:11') },
                { line: 'This, this is a ruler', time: convertTimeToMS('0:12') },
                { line: 'And what is this?', time: convertTimeToMS('0:16') },
                { line: 'That, that is an eraser', time: convertTimeToMS('0:18') },
                { line: 'What are these?', time: convertTimeToMS('0:22') },
                { line: ' Those are pencils I use to write notes', time: convertTimeToMS('0:235') },
                { line: 'What are those?', time: convertTimeToMS('0:275') },
                { line: 'These are crayons, my favorite color is gold', time: convertTimeToMS('0:29') },
                { line: 'I sit at my desk', time: convertTimeToMS('0:33') },
                { line: 'During the class', time: convertTimeToMS('0:358') },
                { line: 'I keep my books and pencils', time: convertTimeToMS('0:38') },
                { line: 'inside my backpack', time: convertTimeToMS('0:40') },
                { line: 'A pencil has lead', time: convertTimeToMS('0:44') },
                { line: 'A pen has ink', time: convertTimeToMS('0:476') },
                { line: 'And I use both to draw amazing things', time: convertTimeToMS('0:49') },
                { line: 'Supplies, supplies, supplies at school', time: convertTimeToMS('0:546') },
                { line: 'Pencils and pens', time: convertTimeToMS('0:579') },
                { line: "Because we've got", time: convertTimeToMS('0:59') },
                { line: 'Supplies, supplies, supplies in class', time: convertTimeToMS('1:005') },
                { line: 'make art with my friends', time: convertTimeToMS('1:03') },
                { line: "You know we've got", time: convertTimeToMS('1:05') },
                { line: 'Supplies, supplies, supplies at school', time: convertTimeToMS('1:065') },
                { line: 'Pencils and pens', time: convertTimeToMS('1:08') },
                { line: "Because we've got", time: convertTimeToMS('1:10') },
                { line: 'Supplies, supplies, supplies in class', time: convertTimeToMS('1:12') },
                { line: 'make art with my friends', time: convertTimeToMS('1:14') },
                { line: 'These are supplies that we use at school', time: convertTimeToMS('1:17') },
                { line: 'a notebook full of paper', time: convertTimeToMS('1:21') },
                { line: 'and a folder that is blue', time: convertTimeToMS('1:24') },
                { line: 'I paint with my paintbrush', time: convertTimeToMS('1:28') },
                { line: 'gold is still my favorite color', time: convertTimeToMS('1:30') },
                { line: 'I use markers to draw a picture', time: convertTimeToMS('1:34') },
                { line: 'for my mother', time: convertTimeToMS('1:367') },
                { line: 'I use glue to stick stuff together', time: convertTimeToMS('1:39') },
                { line: 'to make cool things', time: convertTimeToMS('1:418') },
                { line: 'I keep my pencils in the pencil case', time: convertTimeToMS('1:44') },
                { line: 'it is green', time: convertTimeToMS('1:47') },
                { line: 'I use the sharpener', time: convertTimeToMS('1:50') },
                { line: "when my pencils can't write", time: convertTimeToMS('1:52') },
                { line: 'and I use scissors to cut up paper', time: convertTimeToMS('1:55') },
                { line: 'to make something nice', time: convertTimeToMS('1:58') },
                { line: 'Supplies, supplies, supplies at school', time: convertTimeToMS('2:01') },
                { line: 'Pencils and pens', time: convertTimeToMS('2:04') },
                { line: "Because we've got", time: convertTimeToMS('2:06') },
                { line: 'Supplies, supplies, supplies in class', time: convertTimeToMS('2:07') },
                { line: 'make art with my friends', time: convertTimeToMS('2:082') },
                { line: "You know we've got", time: convertTimeToMS('2:10') },
                { line: 'Supplies, supplies, supplies at school', time: convertTimeToMS('2:125') },
                { line: 'Pencils and pens', time: convertTimeToMS('2:15') },
                { line: "Because we've got", time: convertTimeToMS('2:165') },
                { line: 'Supplies, supplies, supplies in class', time: convertTimeToMS('2:18') },
                { line: 'make art with my friends', time: convertTimeToMS('2:21') },
                { line: '', time: convertTimeToMS('2:21') }
            ]
        },
        flashcards: [
    ...
    },
    {
        ...
        lyricsPlayer: {
            lyrics: [
                ...
                { line: 'they went', time: 36800 },
                { line: 'and we went together', time: convertTimeToMS('0:40') },
                ...
                { line: 'I go you go he goes', time: convertTimeToMS('0:55') },
                { line: 'she goes it goes you go', time: convertTimeToMS('0:585') },
                { line: 'they go and we go together', time: convertTimeToMS('1:015') },
                { line: 'present continuous', time: convertTimeToMS('1:06') },
                { line: 'I am going you are going', time: convertTimeToMS('1:075') },
                { line: 'he is going', time: convertTimeToMS('1:09') },
                { line: 'she is going it is going', time: convertTimeToMS('1:105') },
                { line: 'you are going', time: convertTimeToMS('1:125') },
                { line: 'they are going', time: convertTimeToMS('1:135') },
                { line: 'we are going together', time: convertTimeToMS('1:15') },
                { line: 'simple past', time: convertTimeToMS('1:185') },
                { line: 'I went you went', time: convertTimeToMS('1:205') },
                { line: 'he went she went it went', time: convertTimeToMS('1:22') },
                { line: 'you went', time: convertTimeToMS('1:245') },
