...
// using the .height jQuery function
function align() {
...
$(document).ready(function() {
  $('audio').on('timeupdate', function(e) {
    ...
    // let lyricsDiv = document.querySelector('div.lyricsImage')
    // lyricsDiv.style.background = song.lyricsPlayer.lyrics[past.length].img
